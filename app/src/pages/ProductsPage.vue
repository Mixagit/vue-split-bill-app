<template>
    <div class="container">
        ...
        <div v-if="persons.length < 2" class="empty__list">
            <h4>Недостаточно людей</h4>
            <p>
                Вы можете добавить людей, которые есть в вашем чеке по этой
                <span class="link" @click="$router.push('/persons')"
                    >ссылке</span
                >
            </p>
        </div>
        ...
        >
            <h4>Пустые имена</h4>
            <p>
                Вы не дали имена всем добавленным людям. Вы можете вернуться
                назад по
                <span class="link" @click="$router.push('/persons')"
                    >ссылке</span
                >
        ...
        <div v-else-if="products.length > 0" class="list">
                    ...
                    <div class="params">
                        ...
                        <div class="consumers">
                            ...
                            >
                                <Avatar
                                    :name="
                                        !product.consumers.includes(person.id)
                                            ? person.name
                                            : '&#10003;'
                                    "
                                    class="circle not_selected"
